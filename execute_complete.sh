...
mvn -f $BASE_CODEBASE_PATH/data-generator/pom.xml exec:java 
...
$BASE_INSTALLS_PATH/apache-hive-1.2.1-bin/bin/hive -f $BASE_CODEBASE_PATH/ca-etl/src/main/hive/hive_dataload.hql
